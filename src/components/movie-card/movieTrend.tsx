...
const MovieTrendCard = ({ movie }: movieTrendCardProps) => {
  ...
  return (
    <Card key={movie.id} elevation={0} style={{ background: "transparent" }}>
      <CardContent
        style={{ padding: 0, position: "relative", overflowX: "scroll",  display: "flex",
        }}>
        <img
          src={movie.thumbnail.regular.large} alt=""
        ...
        />
          ...
          >
            <Grid container alignItems="center" spacing={1}>
              ...
              <Grid item>
                <img src={String(movie.category === "Movies" ? MovieIcon : TvSeriesIcon)}
                  alt=""
                  width={16}
                  height={16}
                />
